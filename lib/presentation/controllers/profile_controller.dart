  ...
  final Rx<UserProfile> user = UserProfile(
    ...
    myNovels: [
      UserNovel(
        ...
        author: 'Penulis A',
        coverUrl:
            'https://i.pinimg.com/564x/07/e8/0a/07e80af602edfed53c64b7c2769a6266.jpg',
        category: 'Fantasy',
        views: 1250,
      ),
      UserNovel(
        ...
        author: 'Penulis C',
        coverUrl:
            'https://i.pinimg.com/564x/14/39/5d/14395da9d845a70d820ee974c46b2d64.jpg',
        category: 'Mystery',
        views: 999,
      ),
      UserNovel(
        ...
        author: 'Penulis B',
        coverUrl:
            'https://i.pinimg.com/564x/4f/89/5d/4f895d361b5c2bca65bdf0de6ca1f49b.jpg',
        category: 'Romance',
        views: 2045,
      ),
    ],
    ...
    favoriteNovels: [
      FavoriteNovel(
        ...
        coverUrl:
            'https://i.pinimg.com/564x/70/77/04/707704eef02ec1e95f00b761ddcb6805.jpg',
        genre: 'Fantasy',
        chapterCount: 25,
        views: 8500,
        status: 'Berlanjut',
      ...
      FavoriteNovel(
        ...
        coverUrl:
            'https://i.pinimg.com/564x/e9/0b/0a/e90b0a93aafd8cd1ee49f332ce4f2cee.jpg',
        genre: 'Romance',
        chapterCount: 15,
        views: 5200,
        status: 'Berlanjut',
      ...
      FavoriteNovel(
        ...
        coverUrl:
            'https://i.pinimg.com/564x/93/c8/d0/93c8d0db8defc4093742ac139ba40c2f.jpg',
        genre: 'Mystery',
        chapterCount: 32,
        views: 12100,
        status: 'Selesai',
